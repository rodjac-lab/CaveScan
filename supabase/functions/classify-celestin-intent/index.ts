...
- PAYS ou REGION explicite : renvoyer country seulement si la query nomme le pays ("les vins italiens", "mes espagnols", "des americains"). Renvoyer region seulement si la query nomme la region ("mes Bourgognes", "vins de la Loire", "un Chianti en Toscane"). NE JAMAIS DEDUIRE region A PARTIR D'UN PAYS ou d'une nationalite. "des vins americains" -> {country:"USA"} SEUL, JAMAIS {country:"USA", region:"Californie"}. "vins italiens" -> {country:"Italie"} SEUL, JAMAIS avec region="Toscane" ou "Piemont". Si la query nomme UNIQUEMENT un pays/nationalite, le filtre region DOIT etre absent, meme si tu connais des regions viticoles de ce pays.
